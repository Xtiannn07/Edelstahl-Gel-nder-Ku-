      ...
      <div className="container mx-auto md-px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 md:gap-8 pl-8 px-2">
          ...
          <div className="md:py-4">
            <h3 className="text-sm md:text-xl font-semibold mb-1 md:mb-4">Josef Kuś</h3>
            <p className="text-xs md:text-lg text-gray-300 mb-4">{translations.footer.description}</p>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center md:px-8">
            ...
            <div className=" ">
              <ul className="flex space-x-12">
                <li>
                  <a href="/privacy" className="text-xs md:text-sm text-gray-400 hover:text-white transition-colors">
                    Privacy Policy
                  </a>
                </li>
                <li>
                  <a href="/terms" className="text-xs md:text-sm text-gray-400 hover:text-white transition-colors">
                    Terms of service
                  </a>
                </li>
                <li>
                  <a href="/imprint" className="text-xs md:text-sm text-gray-400 hover:text-white transition-colors">
                    Imprint
                  </a>
                </li>
              </ul>
